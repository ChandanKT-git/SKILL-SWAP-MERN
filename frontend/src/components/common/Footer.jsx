                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 sm:col-span-2 lg:col-span-1">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                            Connect, learn, and grow with your community through skill exchange.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link
                                    to="/about"
                                    className="text-sm text-gray-600 hover:text-primary-600 transition-colors focus-visible-ring rounded"
                                >
                                    About Us
                                </Link>
                            </li>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex items-center space-x-6">
                            <a
                                ...
                                className="text-gray-400 hover:text-gray-600 transition-colors focus-visible-ring rounded"
